    ...
    try:
        ...
        try:
            ...
            await bot.edit_message_text(chat_id=message.chat.id,
                                        ...
                                        text=answer)
            if len(answer) > 200:
                logger.info(f'Успешное завершение ответа на сообщение пользователя: "{answer[:200]}..."')
            else:
                logger.info(f'Успешное завершение ответа на сообщение пользователя: "{answer}"')
